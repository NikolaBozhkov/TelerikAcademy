//TODO
// Spawnvane на повече от една ябълка едновременно с увеличаване на играта

// Obstacles да бъдат изкарани изцяло в метод DrawObstacles();
// Obstacles да бъдат на random позиции и да се увеличават с напредване на играта

// Когато змия се удари в нещо да се инициализира наново, но с по-малко елементи

// Score-а дефакто ще показва дължината на змията и ще се играе до достигане на определена дължина
// Score-a трябва да се оправи

// Ще има няколко режима и единия ще е без да се взимат точки като се докосват змиите.
// Трябва да се направят нива на трудност
...
class MultiSnakeBeta
{
    static void Main(string[] args)
    {
        ...
        while (playGame)
        {
            ...
            while (true)
            {
                ...
                // First snake is hitting the second
                ...
                //Print ScoreBoard
                DrawScoreBoard(firstScore, secondScore);
    ...
    private static void DrawScoreBoard(int firstPoints, int secondPoints)
    {
